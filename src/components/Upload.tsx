import uploadSvd from "../assets/upload.svg";
...
export function Upload({ filename = null, ...rest }: Props) {
  return (
    <div>
      ...
      <div className="w-full h-12 flex items-center rounded-lg border border-gray-300 text-sm text-gray-100 bg-translate outline-none">
        ...
        >
          <img src={uploadSvd} alt="Upload" className="w-6 h-6" />
        </label>
      </div>
    </div>
  );
